...
#Pegando 2/3 dos dados para treinamento
...
#usado somente para plotar os graficos com as labels corretas
...
modelo = qda(D[treino,] , tiposdevinhos[treino])
...
# "Trasformando" matriz confusão multiclasses em uma
#  matriz confusão binaria
# Para isso, os casos em que são de fato classe 2 e classe 3, foram somados e colocados como se fosse uma unica coisa
